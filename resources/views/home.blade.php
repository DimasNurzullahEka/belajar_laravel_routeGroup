...
<head>
    ...
    <title>DhalemZadim Website</title>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <h4>Dhalem<span>Zadim</span></h4>
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="{{ route('front_home') }}" class="active">Home</a>
                            </li>
                            <li class="scroll-to-section"><a href="{{ route('front_contact') }}">Contact</a></li>
                        </ul>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                <div class="section-heading">
                    <h2>Kami Selalu Ada Soluso <em>SEO</em> service &amp; <span>Project</span> Ideas</h2>
                    <p>Kami selalu cepat mengatasi masalah dan hemat budget di perusahaan yang anda bangun</p>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                ...
                <a href="#">
                    <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="hidden-content">
                            <h4>SEO</h4>
                            <p>Mengamplikasikan sesuai aturan SEO yang terbaru</p>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <a href="#">
                    <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="hidden-content">
                            <h4>Plan Bisnis Application</h4>
                            <p>Pembuatan rencana bisnis untuk aplikasi adalah langkah penting untuk memastikan bahwa Anda memiliki pemahaman yang jelas tentang tujuan, strategi, dan jalur yang akan diambil dalam mengembangkan dan mengelola aplikasi tersebut.</p>
                        </div>
                        <div class="showed-content">
                            <img src="{{ asset('assets/images/portfolio-image.png') }}" alt="">
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <a href="#">
                    <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="hidden-content">
                            <h4>Digital Marketing</h4>
                            <p>Pemasaran digital mengacu pada penggunaan teknologi digital untuk mempromosikan produk, layanan, atau merek kepada audiens target.</p>
                        </div>
                        <div class="showed-content">
                            <img src="{{ asset('assets/images/portfolio-image.png') }}" alt="">
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <a href="#">
                    <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                        <div class="hidden-content">
                            <h4>Data Analysis</h4>
                            <p>Mengambil keputusan yang informasional dan strategis.</p>
                        </div>
                        <div class="showed-content">
                            <img src="{{ asset('assets/images/portfolio-image.png') }}" alt="">
                        </div>
